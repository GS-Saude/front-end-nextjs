                        ...
                        <div className={styles.top_profile}>
                            ...
                            <div className={styles.profile_info}>
                                ...
                                <div className={styles.divButtons}>
                                    ...
                                    {cliente.nome && <ButtonSecondary className={styles.edit_button} onClick={() => setIsChangeClient(true)}>{icons.edit}</ButtonSecondary>}
                                    {isChangeClient && (
                        ...
                        <div className={styles.middle_profile}>
                            <div className={styles.trainning}>
                                <div className={styles.trainning_header}>
                                    <h1>Treino</h1>
                                    {cliente?.treino?.id && <ButtonLink onClick={() => setIsChangeTraining(true)}>{icons.edit}</ButtonLink>}
                                    {isChangeTraining && (
                            ...
                            <div className={styles.diet}>
                                <div className={styles.diet_header}>
                                    <h1>Dieta</h1>
                                    {cliente?.dieta?.id && <ButtonLink onClick={() => setIsChangeDiet(true)}>{icons.edit}</ButtonLink>}
                                    {isChangeDiet && (
                        ...
                        <div className={styles.bottom_profile}>
                            <div className={styles.left_container}>
                                <div className={styles.left_container_header}>
                                    <h1>Medidas</h1>
                                    {cliente?.medida?.id && <ButtonLink onClick={() => setIsChangeMeasures(true)}>{icons.edit}</ButtonLink>}
                                    {isChangeMeasures && (
                            ...
                            <div className={styles.right_container}>
                                <div className={styles.right_container_header}>
                                    <h1>Objetivo</h1>
                                    {cliente?.objetivo?.id && <ButtonLink onClick={() => setIsChangeObjective(true)}>{icons.edit}</ButtonLink>}
                                    {isChangeObjective && (
                                ...
                                <div className={styles.objetivo_container}>
                                    ...
                                    <div className={styles.objetivo_info}>
                                        <h6>Data:</h6>
                                        <h5>{cliente?.objetivo?.tempo && formatDate(cliente?.objetivo?.tempo)}</h5>
                                    </div>
                                    <div className={styles.objetivo_info}>
                                        <h6>Peso:</h6>
